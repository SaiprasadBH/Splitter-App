      ...
      <div className="container">
        ...
        <div className={`description ${getDescriptionClass()}`}>
          ...
          <p>
            ...
            quae est nesciunt! Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Ipsam, odio. Doloremque beatae iusto assumenda
            corporis! Assumenda voluptatibus quo velit saepe enim deserunt
            aperiam minus ipsam necessitatibus quos, accusantium dolor beatae?
          </p>
        </div>
      </div>
  );
